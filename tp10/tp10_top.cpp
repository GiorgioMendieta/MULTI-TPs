...
//////////////////////////////////////////////////////////
    ...
    // IOC
    icu.p_irq_in[0]		TO BE COMPLETED // TODO: connect the IRQ_IOC signal
    // in : unused
    for ( size_t x=1 ; x<8 ; x++ )
    {
        icu.p_irq_in[x]		TO BE COMPLETED  // TODO: connect the unused signals
    }
    // in : TIMER & DMA
    for ( size_t p=0 ; p<4 ; p++)
    {
        if( p<nprocs )
        {
            icu.p_irq_in[8+p]	TO BE COMPLETED      // TODO: connect the IRQ_TIM signal
            icu.p_irq_in[12+p]	TO BE COMPLETED      // TODO: connect the IRQ_DMA signal
        }
        else
        {
            icu.p_irq_in[8+p]	TO BE COMPLETED      // TODO: connect the IRQ_TIM signal
    ...
    for ( size_t p=0 ; p<4 ; p++)
    {
        ...
        {
            if( (p<nprocs) and (t<4) )
            icu.p_irq_in[16+p*4+t]	TO BE COMPLETED     // TODO: connect the IRQ_TTY signal
            else
            icu.p_irq_in[16+p*4+t]	TO BE COMPLETED     // TODO: connect the IRQ_TTY signal
        }
    }
    ...
    for ( size_t p=0 ; p<nprocs ; p++)
    {
        icu.p_irq_out[p]  	TO BE COMPLETED       // TODO: 
    }
