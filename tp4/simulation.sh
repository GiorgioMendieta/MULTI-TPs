...
# C
./simul.x -ISETS 256 -IWORDS 16 -IWAYS 4 -DSETS 256 -DWORDS 16 -DWAYS 4 -WBUF 8 -STATS 50 -NCYCLES   74500 > ./Stats/C/simul_1.txt

# D. Influence of the instruction cache capacity
D_PARMS="-IWORDS 8  -IWAYS 1 -DSETS 256 -DWORDS 16 -DWAYS 4 -WBUF 8"
./simul.x -ISETS 256 -IWORDS 8  -IWAYS 1 -DSETS 256 -DWORDS 16 -DWAYS 4 -WBUF 8 -STATS 100 -NCYCLES   85956 > ./Stats/D/simul_1.txt 
./simul.x -ISETS  64 -IWORDS 8  -IWAYS 1 -DSETS 256 -DWORDS 16 -DWAYS 4 -WBUF 8 -STATS 100 -NCYCLES  106270 > ./Stats/D/simul_2.txt
./simul.x -ISETS  16 -IWORDS 8  -IWAYS 1 -DSETS 256 -DWORDS 16 -DWAYS 4 -WBUF 8 -STATS 100 -NCYCLES  152943 > ./Stats/D/simul_3.txt
./simul.x -ISETS   4 -IWORDS 8  -IWAYS 1 -DSETS 256 -DWORDS 16 -DWAYS 4 -WBUF 8 -STATS 100 -NCYCLES  166455 > ./Stats/D/simul_4.txt
./simul.x -ISETS   1 -IWORDS 8  -IWAYS 1 -DSETS 256 -DWORDS 16 -DWAYS 4 -WBUF 8 -STATS 100 -NCYCLES  234079 > ./Stats/D/simul_5.txt

# E. Influence of the cache line width
E_PARMS="-IWAYS 1 -DSETS 256 -DWORDS 16 -DWAYS 4 -WBUF 8"
...
F_PARMS="-ISETS 256 -IWORDS 16 -IWAYS 4 -DWORDS 8 -DWAYS 1 -WBUF 8"
...
# F2. Influence of the cache line width
F2_PARMS="-ISETS 256 -IWORDS 16 -IWAYS 4 -DWAYS 1 -WBUF 8"
...
G_PARMS="-ISETS 256 -IWORDS 16 -IWAYS 4 -DSETS 256 -DWORDS 16 -DWAYS 4 -WBUF 8"
